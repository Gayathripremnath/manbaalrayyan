...
`;
    ...
    window.location.href =
      `mailto:martenquiries@gmail.com?subject=${encodeURIComponent(
        subject
    ...
    <main className="modern-contact">
      ...
      <section className="contact-modern-hero">
        ...
        <div className="contact-hero-inner">
          ...
          >
            ...
            <p>
              Have a project, requirement or
              technical enquiry? Tell us what
              you need and our team will help
      ...
      >
        ...
        >
          ...
          <p>
            From RO and desalination systems
            to wastewater treatment, filtration,
            STP and operation & maintenance,
            our team can support your water
